...
namespace DirectOPCClient
{
	...
	protected void theGrp_DataChange( object sender, DataChangeEventArgs e )
		...
		foreach( OPCItemState s in e.sts )
			...
			if( HRESULTS.Succeeded( s.Error ) )
                ...
                try 
                { 
                    txtItemValue.BeginInvoke(new Action(() =>
                    {
                        txtItemValue.Text = s.DataValue.ToString();
                    }));

                    txtItemQual.BeginInvoke(new Action(() =>
                    {
                        txtItemQual.Text = OpcGroup.QualityToString(s.Quality);
                    }));

                    txtItemTimeSt.BeginInvoke(new Action(() =>
                    {
	...
	protected void theGrp_WriteComplete( object sender, WriteCompleteEventArgs e )
		...
		foreach( OPCWriteResult w in e.res )
			...
			if( HRESULTS.Failed( w.Error ) )
                ...
                txtItemWriteRes.BeginInvoke(new Action(() =>
                    {
	...
	protected override void Dispose( bool disposing )
		...
		private void InitializeComponent()
		{
            ...
            this.txtItemDataType.Size = new System.Drawing.Size(234, 20);
            ...
            this.txtItemID.Size = new System.Drawing.Size(667, 20);
            ...
            this.listOpcView.Location = new System.Drawing.Point(294, 32);
            this.listOpcView.MultiSelect = false;
            this.listOpcView.Name = "listOpcView";
            this.listOpcView.Size = new System.Drawing.Size(381, 200);
            ...
            // txtServerInfo
            // 
            this.txtServerInfo.Location = new System.Drawing.Point(294, 8);
            this.txtServerInfo.Name = "txtServerInfo";
            this.txtServerInfo.ReadOnly = true;
            this.txtServerInfo.Size = new System.Drawing.Size(381, 20);
            ...
            this.txtItemWriteRes.Size = new System.Drawing.Size(202, 20);
            ...
            this.txtItemTimeSt.Size = new System.Drawing.Size(234, 20);
            this.txtItemTimeSt.TabIndex = 6;
            // 
            // statusBarMain
            // 
            this.statusBarMain.Location = new System.Drawing.Point(0, 424);
            ...
            this.statusBarMain.Size = new System.Drawing.Size(681, 16);
            ...
            this.treeOpcItems.Size = new System.Drawing.Size(280, 200);
            ...
            // btn_About
            // 
            this.btn_About.BackColor = System.Drawing.SystemColors.InactiveCaption;
            this.btn_About.Location = new System.Drawing.Point(605, 360);
            this.btn_About.Name = "btn_About";
            this.btn_About.Size = new System.Drawing.Size(64, 24);
